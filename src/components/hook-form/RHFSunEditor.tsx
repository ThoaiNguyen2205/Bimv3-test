...
const RHFSunEditor = (props: PropsObject) => {
    ...
    */
    ...
    const handleImageUploadBefore = (files: File[], info: object, uploadHandler: UploadBeforeHandler) => {
        try {
            ...
            uploadsApi.uploadImage(formData, (e: any) => {})
                .then((res: IUploadRes) => {
                    const response = {
     ...
     */
    const handleImageUpload = (targetImgElement: HTMLImageElement, index: number, state: string, imageInfo: UploadInfo<HTMLImageElement>, remainingFilesCount: number) => {
