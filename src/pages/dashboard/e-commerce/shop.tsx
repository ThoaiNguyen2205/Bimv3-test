...
export default function EcommerceShopPage() {
  ...
  const { datas, checkout } = useSelector((state) => state.product);
  ...
  const dataFiltered = applyFilter(datas, values);
  ...
  return (
    <>
      <Head>
        <title> Ecommerce: Shop | BIMNEXT V3</title>
      </Head>
      ...
      <FormProvider methods={methods}>
        <Container maxWidth={themeStretch ? false : 'lg'}>
          ...
          <ShopProductList products={dataFiltered} loading={!datas.length && isDefault} />
