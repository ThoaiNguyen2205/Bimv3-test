...
export default function OfficeCollabItem({
  linkFolderId,
  imageData,
  handleClick,
  onDeleteForgeObject,
          ...
          >
            <Stack alignItems="center" spacing={1} >
              <m.div variants={varHover(1.1)} transition={varTranHover()} >
                <Image alt={imageData.forgeObject.displayName} src={process.env.REACT_APP_APIFILE + 'images/' + localState.ext + '.png'} sx={{ height: 60, borderRadius: 2, }} />
              </m.div>
            </Stack>
          </CardActionArea>
        </Stack>
