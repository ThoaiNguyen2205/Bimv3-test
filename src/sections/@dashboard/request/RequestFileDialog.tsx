...
import TaskFileCard from '../task/TaskFileCard';
// components
...
export default function RequestFileDialog({ open, onClose, ...other }: Props) {
  ...
  const jumpToFilesManager = () => {
    ...
    router.push(`${PATH_DASHBOARD.cloud.filesManager}?folder=${selectedFolder?._id}`)
  }
