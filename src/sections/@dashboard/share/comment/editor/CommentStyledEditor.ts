...
export const CommentStyledEditor = styled(Box)(({ theme }) => ({
  overflow: 'hidden',
  position: 'relative',
  ...
  '& span.attach-icon': {
    content: `url('https://api.iconify.design/mi/attachment.svg')`
  },
  '& p': {
    margin: 0
  },
...
export const CommentStyledEditorToolbar = styled('div')(({ theme }) => {
